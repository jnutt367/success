...
.fromTo("h1", { y: -1000, x: 100, opacity: 0 }, { color: "skyblue", duration: 2, x: 0, ease: "elastic", fontSize: "30", fontFamily: "cursive", y: -130, opacity: 1 }, 10)
    ...
    .fromTo("body", { backgroundColor: "transparent", opacity: 0 }, { duration: 10, backgroundColor: "skyblue", opacity: 1 }, 0)
    .to("h2", { color: "white", repeat: 3, fontFamily: "serif", borderRadius: "10" })
